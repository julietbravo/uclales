...
contains
  ...
  subroutine define_parm
    ...
    use radiation, only : u0, fixed_sun, rad_eff_radius, fixed_lwin, flwin, radMcICA, heating_atmosphere
    ...
    namelist /model/  &
         ...
         rh_srf, drag, &
         SolarConstant,u0,fixed_sun, rad_eff_radius, radMcICA, heating_atmosphere, & ! SolarConstant (In case of prescribed TOA radiation
